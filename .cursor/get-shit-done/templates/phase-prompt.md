...
<!-- For checkpoint task examples and patterns, see @C:/Dev/LeanQuill/.cursor/get-shit-done/references/checkpoints.md -->
...
See `C:/Dev/LeanQuill/.cursor/get-shit-done/references/tdd.md` for TDD plan structure.
...
See `C:/Dev/LeanQuill/.cursor/get-shit-done/templates/user-setup.md` for full schema and examples
...
See `C:/Dev/LeanQuill/.cursor/get-shit-done/workflows/verify-phase.md` for verification logic.
