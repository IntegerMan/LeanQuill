...
Use template from `C:/Dev/LeanQuill/.cursor/get-shit-done/templates/UI-SPEC.md`.
...
Read template: `C:/Dev/LeanQuill/.cursor/get-shit-done/templates/UI-SPEC.md`
...
```bash
node "C:/Dev/LeanQuill/.cursor/get-shit-done/bin/gsd-tools.cjs" commit "docs($PHASE): UI design contract" --files "$PHASE_DIR/$PADDED_PHASE-UI-SPEC.md"
```
