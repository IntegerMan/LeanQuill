...
Reference full template: `C:/Dev/LeanQuill/.claude/get-shit-done/templates/roadmap.md`

## STATE.md Structure

Use template from `C:/Dev/LeanQuill/.claude/get-shit-done/templates/state.md`.
