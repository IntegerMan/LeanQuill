...
- [x] **ISSUE-03**: Author can filter the issue list by status: open / deferred / dismissed / all
- [x] **ISSUE-04**: Issues with a `span_hint` referencing a manuscript text fragment display as gutter indicator icons in the editor margin, providing spatially precise issue awareness without leaving the writing surface
